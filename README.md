...
- prompt navigator tabs: `Session` shows parsed branch/state views sourced from the current session file, `System Prompt` shows the exact full runtime prompt plus source breakdown, `Tools` shows active tool metadata
